...
DL_DBG_LR = 0.5
DL_DBG_OVERFIT_EPS_RATIO = 0.05  # epsilon =
# DL_DBG_OVERFIT_EPS_RATIO*(mean of target)
DL_DBG_BS_PCT = 0.125  # batch size = floor{(trainset size)*DL_DBG_BS}
...
DL_DBG_IIB_THRESHOLD = 0.75  # the factor, k = (real_data_loss / zero_data_loss), below which the IIB test will pass
DL_DBG_IIB_NSHOW = 5
DL_DBG_OVERFIT_BS = 5
...
DL_DBG_SUFFICIENT_R2_SMALL_BATCH = 0.99
SAVE_GRAD_IMG = False
